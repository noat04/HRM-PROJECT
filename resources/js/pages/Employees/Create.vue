    ...
    <AppLayout :breadcrumbs="breadcrumbs">
       <div class="space-y-6 p-6 max-w-3xl mx-auto w-full">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Thêm mới nhân viên</h1>
        ...
        <Card>
            ...
            <CardContent>
                <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Ngày vào làm <span class="text-destructive">*</span></label>
                        <input 
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Số tài khoản ngân hàng <span class="text-destructive">*</span></label>
                        <input 
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Tên ngân hàng <span class="text-destructive">*</span></label>
                        <input 
                    ...
                    <div class="space-y-2">
                        ...
                        <select 
                            ...
                            required 
                        >
                            <option v-for="status in EmployeeStatus.options()" :key="status.value" :value="status.value">{{ status.label }}</option>
                        </select>
                        <p v-if="form.errors.status" class="text-sm text-destructive">{{ form.errors.status }}</p>
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Phòng ban <span class="text-destructive">*</span></label>
                        <select 
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Chức vụ <span class="text-destructive">*</span></label>
                        <select 
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Người quản lý <span class="text-destructive">*</span></label>
                        <select 
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium">Tài khoản người dùng <span class="text-destructive">*</span></label>
                        <select 
