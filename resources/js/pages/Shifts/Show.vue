...
const form = useForm({
    ...
    grace_period: props.shift.grace_period,
    work_days: props.shift.work_days,
    description: props.shift.description,
    status: props.shift.status,
    total_hours: props.shift.total_hours,
    is_overnight: props.shift.is_overnight,
});
...
<template>
    <Head title="Chi tiết Ca làm việc" />
       ...
       <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-6 max-w-4xl mx-auto w-full">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Chi tiết Ca làm việc</h1>
                    <p class="text-muted-foreground">Xem thông tin chi tiết ca làm việc.</p>
                </div>
            </div>
