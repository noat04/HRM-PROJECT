...
const breadcrumbs:BreadcrumbItem[] = [
    ...
    { title: 'Tạo mới', href: '/leaves/balances/create' },
];

const submit = () => {
    form.post('/leaves/balances');
};
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-6 max-w-4xl mx-auto w-full">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Tạo mới Số dư nghỉ phép</h1>
                    <p class="text-muted-foreground">Thêm số dư nghỉ phép mới vào hệ thống.</p>
                </div>
            </div>
