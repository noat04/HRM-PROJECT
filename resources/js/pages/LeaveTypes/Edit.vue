...
const form = useForm({
    ...
    days_allowed: props.leaveType.days_allowed,
    
    // 👇 Thêm 2 dấu chấm than (!!) để ép số 1/0 thành boolean true/false
...
const submitForm = () => {
    form.put(`/leaves/types/${props.leaveType.id}`);
};
...
<template>
    <Head title="Chỉnh sửa Loại nghỉ phép" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-6 max-w-4xl mx-auto w-full">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Chỉnh sửa Loại nghỉ phép</h1>
                    <p class="text-muted-foreground">Cập nhật thông tin loại nghỉ phép.</p>
                </div>
            </div>
